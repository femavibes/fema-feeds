    ...
    <>
      ...
      <div className="marketplace-sidebar-body sidebar-scroll">
        <div className="community-detail-content">
          ...
          {(feed.likeCount != null || feed.dailyViewers != null || feed.dailyImpressions != null || (feed.deploymentHost && feed.source === 'global')) && (
