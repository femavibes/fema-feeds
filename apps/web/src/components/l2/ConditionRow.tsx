  ...
  return (
    ...
    >
      ...
      <div className="l2-condition-body">
        ...
        {(node.type === 'substitute' || node.type === 'scout') && (
          <div className="l2-condition-stack">
            <ConditionHead
              title={node.type === 'scout' ? 'Scout (deprecated)' : 'Substitute (deprecated)'}
              onRemove={onRemove}
              showRemove={showRemove}
            />
            <p className="card-hint">
              Remove this node and configure {node.type === 'scout' ? 'Scout' : 'Substitute'} on the
              Sources tab, then wire the ingress node on the canvas.
            </p>
          </div>
        )}
      </div>
